...
*July 2026.* Bilingual (French original, English version). A reading of *Fortis Advisors v. Krafton* (Delaware, 16 March 2026) from a workshop that delegates to agents every day. A CEO asks ChatGPT how to avoid paying a $250 million earnout; the model first gives him the correct answer, exactly the one his own lawyer gave; he reframes until he gets a plan, and his company executes it. What the coverage missed: the tool did not hallucinate, the guardrail was not breached but routed around by reframing, and the evidence never came from OpenAI but from the copy-paste. On algorithmic forum shopping, the loss of privilege, the leveraged earnout that turns a studio's success into its parent's liability, and the memo that circulates with the authority of expertise and zero attached responsibility. With an adversarial file defending the tool, and a coda: a sovereign workshop is not only one whose machines you own, it is one where every memo has an author. Continuing from parts 15 and 16.
